...
from scikms.kms.repositories.models import PaperDuplicateRef
from scikms.kms.repositories.papers import (delete_paper_row,
...
def check_duplicate(md5: str, doi: str, title: str) -> PaperDuplicateRef | None:
    """
    Check Duplicates of the MD5, DOI and the title where it shows more than 85% overlap
    """
    if md5:
